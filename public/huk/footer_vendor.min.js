        ...
        */
        ...
        addFilter("token", function(token, data, tag){
            ...
            for (; i < len; i++){
                ...
                // Property not found
                if (dataLookup === undef){
                    // Achtung Änderung des Original-Code:
                    // Wenn im Template ein Wert verlangt wird, der nicht existiert, wird jetzt ein Leerstring zurückgegeben (vorher kam eine Exception)
